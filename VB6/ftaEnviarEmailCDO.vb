'---------------------------------------------------------------------------------------'
'Procedure: ftaEnviarEmailCDO                                                           '
'Autor: Thiago                                                                          '
'Data: 04/07/2022                                                                       '
'Propósito: Enviar com ou sem anexo                                                     '
'Observação: É necessário o componente Microsoft CDO to Windows 2000                    '
'---------------------------------------------------------------------------------------'
...
'Verifica se foi passado anexo
    ...
    'Verificando copia oculta e anexo
         If strCC_email <> "" Then .CC = strCC
         If strCCO_email <> "" Then .BCC = strBcc
